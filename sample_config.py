...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/qithoniq/drago.git"
    )
    ...
    # specify NO_LOAD with plugin names for not loading in drago
    ...
    # set this with r deequired folder path to act as download folder
