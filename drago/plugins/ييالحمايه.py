...
@dragoiq.on(events.NewMessage(outgoing=None, pattern=r"^.الحماية تفعيل$"))
...
@dragoiq.on(events.NewMessage(outgoing=None, pattern=r"^.الحماية اطفاء$"))
...
@dragoiq.on(events.NewMessage(outgoing=None, pattern=r"^.استثناء$"))
...
@dragoiq.on(events.NewMessage(outgoing=None, pattern=r"^.ازالة_استثناء$"))
