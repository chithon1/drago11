...
@dragoiq.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@dragoiq.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@dragoiq.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
