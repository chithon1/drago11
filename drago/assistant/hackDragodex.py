...
'''
mm = '''
قم بلأنضمام الى قناة دراكو @Drago_dr
'''
...
keyboard = [
  ...
  [
    Button.url("‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐃𝐫𝐚𝐠𝐨 ›", "https://t.me/Drago_dr")
    ]
]
...
async def op(event):
    ...
    await event.edit(f"**⌁︙ قم بالدخول لبوتك من هنا @{drago} \n وكتابة الامر /hack** ")
