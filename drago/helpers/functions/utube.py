...
PATH = "./drago/cache/ytsearch.json"
...
async def yt_search(drago):
    try:
        drago = urllib.parse.quote(drago)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={drago}"
        )
...
"""
async def yt_data(drago):
    params = {"format": "json", "url": drago}
